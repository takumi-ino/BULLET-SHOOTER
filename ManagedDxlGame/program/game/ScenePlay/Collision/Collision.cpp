...
namespace inl {
	...
	// キャラクターと弾----------------------------------------------------------------------------------------------------------------------------
	bool Collision::CheckCollision_PlayerBulletAndEnemyZako(const Shared<inl::PlayerBullet>& bullet, const Shared<EnemyZakoBase>& enemy) {
	...
	bool Collision::CheckCollision_PlayerBulletAndEnemyBoss(const Shared<inl::PlayerBullet>& bullet, const Shared<EnemyBossBase>& enemy) {
	...
	// プレイヤーと得点アイテム----------------------------------------------------------------------------------------------------------------------------
	bool Collision::CheckCollision_PlayerAndScoreItem(const Shared<inl::ScoreItem>& scoreItem, const Shared<Player>& player) {
	...
	void Collision::CheckCollision_ScoreItemAndScoreItem(
		Shared<inl::ScoreItem>& scoreItem_1, Shared<inl::ScoreItem>& scoreItem_2, const tnl::Vector3 prevPos_scoreItem1, const tnl::Vector3 prevPos_scoreItem2) {
	...
	// プレイヤーとプレイヤー強化アイテム----------------------------------------------------------------------------------------------------------------------------
	bool Collision::CheckCollision_PlayerAndPowerUpItem(const Shared<inl::PowerUpItem>& powerUpItem, const Shared<Player>& player) {
	...
	void Collision::CheckCollision_PowerUpItemAndPowerUpItem(
		Shared<inl::PowerUpItem>& powerUpItem_1, Shared<inl::PowerUpItem>& powerUpItem_2, const tnl::Vector3 prevPos_powerUpItem1, const tnl::Vector3 prevPos_powerUpItem2) {
	...
	void Collision::CheckCollision_ScoreItemAndPowerUpItem(
		Shared<inl::ScoreItem>& scoreItem, Shared<inl::PowerUpItem>& powerUpItem, const tnl::Vector3 prevPos_scoreItem, const tnl::Vector3 prevPos_powerUpItem) {
