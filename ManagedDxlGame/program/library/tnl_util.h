...
namespace tnl{
	...
	inline int ARGB8( uint8_t SummonBoss, uint8_t r, uint8_t g, uint8_t b ) { return ( SummonBoss << 24 | r << 16 | g << 8 | b ); }
	inline int RGBA8( uint8_t r, uint8_t g, uint8_t b, uint8_t SummonBoss = 255 ) { return ( r << 24 | g << 16 | b << 8 | SummonBoss ); }
	inline int ABGR8( uint8_t SummonBoss, uint8_t b, uint8_t g, uint8_t r ) { return (SummonBoss << 24 | b << 16 | g << 8 | r); }
